...
//     // Function to add sortable functionality to a list
...
//     // Make the cards sortable within their respective lists
//     document.querySelectorAll('.list').forEach(function (list) {
//         makeListSortable(list);

//         // Add event listener to "Add Card" button
//         list.querySelector('.add-card-button').addEventListener('click', function () {
//             var newCard = document.createElement('div');
//             newCard.classList.add('card');
//             newCard.textContent = 'New Task';
//             list.insertBefore(newCard, list.querySelector('.add-card-button'));
//         });
//     });
...
//             newCard.classList.add('card');
//             newCard.textContent = 'New Task';
//             newList.insertBefore(newCard, addCardButton);
//         });
//     });
// });
