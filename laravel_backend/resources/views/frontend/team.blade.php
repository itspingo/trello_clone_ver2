  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6">
        <div class="team-member">
          <div class="team-images">
            <img class="img-fluid rounded" src="{{url('website/assets/images/team/01.jpg')}}" alt="">
      ...
      <div class="col-lg-3 col-md-6 mt-7 mt-md-0">
        <div class="team-member">
          <div class="team-images">
            <img class="img-fluid rounded" src="{{url('website/assets/images/team/02.jpg')}}" alt="">
            <div class="social-icons team-social-icon">
              <ul>
                <li>
                  <a href="#">
      ...
      <div class="col-lg-3 col-md-6 mt-7 mt-lg-0">
        <div class="team-member">
          <div class="team-images">
            <img class="img-fluid rounded" src="{{url('website/assets/images/team/03.jpg')}}" alt="">
            <div class="social-icons team-social-icon">
              <ul>
                <li>
                  <a href="#">
      ...
      <div class="col-lg-3 col-md-6 mt-7 mt-lg-0">
        <div class="team-member">
          <div class="team-images">
            <img class="img-fluid rounded" src="{{url('website/assets/images/team/04.jpg')}}" alt="">
            <div class="social-icons team-social-icon">
              <ul>
                <li>
                  <a href="#">
