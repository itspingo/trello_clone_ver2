    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.card_buttons.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.card_buttons')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="button_icon">BUTTON ICON</label>
		<input
			type="text"
			id="button_icon"
			name="button_icon"
			class="form-control"
			value="@if(isset($row->button_icon)){{$row->button_icon}}@endif"
			
		/>
	</div>
	<div id="diverr_button_icon" text-danger></div>
</div>
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		...
		<input
			...
			name="button_label"
			class="form-control"
			value="@if(isset($row->button_label)){{$row->button_label}}@endif"
			
		/>
	</div>
	<div id="diverr_button_label" text-danger></div>
</div>
