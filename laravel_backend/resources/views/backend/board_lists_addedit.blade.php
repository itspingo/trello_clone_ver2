    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.board_lists.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.board_lists')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
@php
    ...
    if(!Empty($row)){ 
        $selected = $row->board_id; 
    }else{
        $selected = '';
    }
    $options = get_list_values('boards','title');
    //pre($options);
	//$options = $board_id;
 @endphp
 ...
 <div id="diverr_board_id" text-danger></div>
</div>
