    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.check_lists.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.check_lists')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="check_list_title">CHECK LIST TITLE</label>
		<input
			type="text"
			id="check_list_title"
			name="check_list_title"
			class="form-control"
			value="@if(isset($row->check_list_title)){{$row->check_list_title}}@endif"
			
		/>
	</div>
	<div id="diverr_check_list_title" text-danger></div>
</div>
