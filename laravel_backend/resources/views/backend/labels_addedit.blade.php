    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.labels.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.labels')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		...
		<input
			...
			name="label_color"
			class="form-control"
			value="@if(isset($row->label_color)) {{ $row->label_color }} @endif"
			
		/>
		
	</div>
	<div id="diverr_label_color" text-danger></div>
</div>


<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="label_text">LABEL TEXT</label>
		<input
			type="text"
			id="label_text"
			name="label_text"
			class="form-control"
			value="@if(isset($row->label_text)){{$row->label_text}}@endif"
			
		/>
	</div>
	<div id="diverr_label_text" text-danger></div>
</div>
