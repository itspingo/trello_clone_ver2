...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.attachment.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.attachment')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
    ...
    <label class="form-label" for="card_id">CARD TITLE</label>
...
@php
    ...
    $options = get_list_values('list_cards','title');
    //pre($options);
	//$options = $card_id;
 @endphp
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		...
		<input
			...
			name="file_name"
			class="form-control"
			value="@if(isset($row->file_name)){{$row->file_name}}@endif"
			
		/>
	</div>
	<div id="diverr_file_name" text-danger></div>
</div>


<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="file_attached">FILE ATTACHED</label>
		<input
			type="file"
			id="file_attached"
			name="file_attached"
			...
			<div>			   
			    @php 
					if(!Empty($row)){ 
						echo '<a target="_BLANK" href="'.$row->file_attached.'" >'.$row->file_attached.'</a>';
					} 
				@endphp
			</div>
			
	</div>
	<div id="diverr_file_attached" text-danger></div>
</div>
...
<div class="col-md-12 mt-3">
	<div class="form-group">
		...
		<textarea
			...
			>@if(isset($row->comment)){{$row->comment}}@endif</textarea>
			
	</div>
	<div id="diverr_comment" text-danger></div>
</div>
